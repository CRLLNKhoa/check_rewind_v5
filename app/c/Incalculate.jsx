  ...
  return (
    <div className="flex gap-4 items-center flex-wrap">
      ...
      <input
         ...
         disabled={!wt}
        type="number"
        className={cn("outline-none cursor-not-allowed w-[102px] text-center text-green-500 bg-black/40 select-none font-bold", wt && "bg-transparent outline-none border-b w-[102px] text-center cursor-pointer")}
